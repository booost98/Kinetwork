                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp | BluetoothGattCharacteristic.PROPERTY_READ) > 0) {
                            ...
                            Toast.makeText(DeviceControlActivity.this, "Selected vital sign is being acquired. Make sure selected vital sign service is currently running on smartwatch. Waiting for smartwatch data . . .", Toast.LENGTH_LONG).show();
                        }
